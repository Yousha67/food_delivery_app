        ...
        child: Column(
          children: [
            Container(
              ...
              child:Text("Password Recovery",style: TextStyle(fontSize: 35.0,color: Colors.white,fontWeight: FontWeight.bold),),



            ),
            SizedBox(height: 10,),
            Text("Enter Your E-mail",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25.0,color: Colors.white),),
           SizedBox(height: 8.0,),
            Form(
              key: _formkey,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Colors.white,width: 5,),borderRadius:BorderRadius.circular(25.0) ),
                child: TextFormField(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text("Send E-mail",style: TextStyle(
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text("Create",style: TextStyle(color: Colors.orangeAccent,
